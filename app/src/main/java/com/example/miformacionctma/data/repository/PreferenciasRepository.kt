...
class DataStorePreferenciasRepository(private val dataStore: DataStore<Preferences>) : PreferenciasRepository {
    ...
    private object Keys {
        ...
        val recordatoriosActivos = booleanPreferencesKey("recordatorios_activos")
    }
    ...
    override val preferencias: Flow<PreferenciasUsuario> = dataStore.data.map { p ->
        PreferenciasUsuario(
            ...
            recordatoriosActivos = p[Keys.recordatoriosActivos] ?: false
        )
    }
    ...
    override suspend fun guardarRecordatoriosActivos(activos: Boolean) {
        dataStore.edit { p ->
            p[Keys.recordatoriosActivos] = activos
        }
    }
}
