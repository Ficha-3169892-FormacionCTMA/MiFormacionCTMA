...
class ActividadesViewModel(
    ...
    fun guardarEvidencia(uri: android.net.Uri, mimeType: String, size: Long) {
        val actividadId = _actividadSeleccionadaId.value ?: return
        viewModelScope.launch {
            ...
            actividadRepository.guardarEvidencia(evidencia)
        }
    }

    fun observarEvidencias(actividadId: Long): Flow<List<EvidenciaEntity>> =
        actividadRepository.observarEvidencias(actividadId)
